//! Seed resolution and logging for the driver-training binary.
//!
//! A small copy of the CLI's `resolve_seed`: `train-driver` is a separate
...
//! lines is cleaner than introducing a crate solely to share them.
